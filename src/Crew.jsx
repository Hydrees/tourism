...
export default function Crew() {
    ...
    return (
        <main className="space-y-10 md:space-y-2  p-10 text-white  bg-[#0B0D17] min-h-screen">
            ...
            <section className="flex flex-col md:flex-row-reverse items-center gap-5 md:p-30 md:gap-50  md:-mt-30  ">
                ...
                <div className="flex flex-col md:flex-col-reverse   text-center md:text-left text-white gap-5 md:gap-10">
                    ...
                    {activeDot === "c" && (
                        <div className="flex flex-col text-center md:text-left gap-5 md:gap-2">
                            ...
                            <h1 className="text-3xl md:text-3xl font-serif md:w-fit text-center md:text-left">VICTOR GLOVER</h1>
                    ...
                    {activeDot === "d" && (
                        <div className="flex flex-col text-center md:text-left gap-5 md:gap-2">
                            ...
                            <h1 className="text-3xl md:text-3xl font-serif md:w-fit text-center md:text-left">ANOUSHEH ANSARI</h1>
