...
import Destinabg from "./assets/Pictures/destinationbg.jpg"
...
export default function Destination() {
    ...
    return (
        <main className="flex flex-col justify-center md:items-start  -mt-20 px-10 text-white space-y-5  min-h-screen" style={{ backgroundImage: `url(${Destinabg})` }}>
            <div className=" text-center md:text-left md:pl-20 pt-15">
                <p className="text-xl"> PICK YOUR DESTINATION</p>
            </div>


            <section className="flex flex-col md:flex-row items-center gap-5 md:p-20 md:space-x-70 md:px-50 md:-mt-10  ">
                ...
                <div className="flex flex-col   text-center md:text-left text-white gap-5">
                    ...
                    {activeList === "moon" && (
                        <div className="flex flex-col text-center md:text-left gap-5">
                            <h1 className="text-5xl text-center md:text-left">MOON</h1>
                    ...
                    {activeList === "mars" && (
                        <div className="flex flex-col text-center md:text-left gap-5">
                            <h1 className="text-5xl text-center md:text-left">MARS</h1>
                    ...
                    {activeList === "europa" && (
                        <div className="flex flex-col text-center md:text-left gap-5">
                            <h1 className="text-5xl text-center md:text-left">EUROPA</h1>
                    ...
                    {activeList === "titan" && (
                        <div className="flex flex-col text-center md:text-left gap-5">
                            <h1 className="text-5xl text-center md:text-left">TITAN</h1>
                    ...
                    {activeList === "moon" && (
                        <div className="flex flex-col md:flex-row items-center text-center md:text-left gap-5">
                            <div>
                                ...
                                <h2 className="text-2xl">384,400 KM</h2>
                            </div>
                            <div>
                                <p className="text-[#D0D6F9]">EST. TRAVEL TIME</p>
                                <h2 className="text-2xl">3 DAYS</h2>
                            </div>
                        </div>
                    )}
                    {activeList === "mars" && (
                        <div className="flex flex-col md:flex-row items-center text-center md:text-left gap-5">
                            <div>
                                <p className="text-[#D0D6F9]">AVG. DISTANCE</p>
                                <h2 className="text-2xl">225 MIL. KM</h2>
                            </div>
                            <div>
                                <p className="text-[#D0D6F9]">EST. TRAVEL TIME</p>
                                <h2 className="text-2xl">9 MONTHS</h2>
                            </div>
                        </div>
                    )}
                    {activeList === "europa" && (
                        <div className="flex flex-col md:flex-row items-center text-center md:text-left gap-5">
                            <div>
                                <p className="text-[#D0D6F9]">AVG. DISTANCE</p>
                                <h2 className="text-2xl">628 MIL. KM</h2>
                            </div>
                            <div>
                                <p className="text-[#D0D6F9]">EST. TRAVEL TIME</p>
                                <h2 className="text-2xl">3 YEARS</h2>
                            </div>
                        </div>
                    )}
                    {activeList === "titan" && (
                        <div className="flex flex-col md:flex-row items-center text-center md:text-left gap-5">
                            <div>
                                <p className="text-[#D0D6F9]">AVG. DISTANCE</p>
                                <h2 className="text-2xl">1.6 BIL. KM</h2>
                            </div>
                            <div>
                                <p className="text-[#D0D6F9]">EST. TRAVEL TIME</p>
                                <h2 className="text-2xl">7 YEARS</h2>
                            </div>
                        </div>
                    )}
                </div>
