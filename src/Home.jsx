...
export default function Home() {
    return (
        <section >
            <section className=" flex flex-col md:flex-row  items-center  justify-center md:items-end  h-screen  gap-20 p-3 -mt-20  md:p-10  md:space-x-80 " style={{ backgroundImage: `url(${Deskhome})` }}>
